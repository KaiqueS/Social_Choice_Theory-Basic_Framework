...
// TODO: make it possible for one to enable/disable indifference -> Create a vector with values from 0 to profile.size.
// Select a value from the vector, assign it to a option, remove from the vector, granted that there are no repeated
